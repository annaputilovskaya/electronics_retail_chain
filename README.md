...
Язык программирования:
 - Python (3.11)
Фреймворк:
 - Django для реализации REST API с использованием Django REST Framework (DRF 3.15.2)
База данных:
 - PostgreSQL для хранения данных (16.4)
ORM:
 - Django ORM для взаимодействия с базой данных (4.2)
